        ...
        >
            ...
            {[
              {
                ...
                d: "ПКПС, «Дизайнер (по отраслям)» (2021–2024), красный диплом. Развитие системного мышления, внимания к деталям и работы по строгим техническим стандартам.",
          ...
          <div className="border-t border-white/10 pt-8 mt-8">
            ...
            <div className="grid sm:grid-cols-3 gap-8">
              {[
                {
                  t: "Дизайнер-проектировщик · РЭЛАН",
                  d: "Проектирование корпусной мебели в PRO100, создание чертежей в SPlan. Складской учёт в «Инфо-Предприятии» — выявление дефектов устаревшего интерфейса. Спроектировала Price Checker (парсер маркетплейсов) и Data Validator (сверка конструкторских данных).",
                },
                {
                  t: "Промышленный и музейный дизайн",
                  d: "Лысьвенский металлургический завод (ММК) — проектирование офисных модулей под жесткие промышленные требования. Лысьвенский музей — оформление выставочных экспозиций по строгому ТЗ с нулевой толерантностью к ошибкам.",
                },
                {
