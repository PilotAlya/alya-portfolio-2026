...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto mb-10 flex items-start justify-between gap-6">
      ...
      <motion.div style={{ y, opacity }} className="relative max-w-7xl mx-auto space-y-7 lg:space-y-9">
        ...
        <p className="text-lg sm:text-xl text-foreground/75 max-w-[36rem] font-normal leading-relaxed">
