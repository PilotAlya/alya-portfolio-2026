        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 items-start">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
              Тестовое задание — Яндекс.Браузер
            </h2>

            <p className="text-muted-foreground leading-relaxed text-sm sm:text-base mb-6">
              Выполнила тестовое для QA: часть 1 — работа с ОС (файловая структура, архив, пути);
              часть 2 — прогон 3 тест-кейсов по интерфейсу браузера (боковая панель, PWA-приложения,
              группы вкладок) с баг-репортами по найденным расхождениям.
            </p>
