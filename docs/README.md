# Сопроводительные письма · Альбина Акбарова (на проектах — Аля)
...
## По вакансиям (готовые черновики)
...
| [cover-letter-online-school1-proofreader.md](./cover-letter-online-school1-proofreader.md) | Онлайн-школа №1 · корректор (stretch) + анкета |
...
| [cover-letter-baro-parts-procurement-us.md](./cover-letter-baro-parts-procurement-us.md) | BARO Service · поиск запчастей США (график NY) |
...
| [questionnaire-strengths-weaknesses.md](./questionnaire-strengths-weaknesses.md) | Анкета: 3 сильных / 3 слабых качества |
...
| [answers-why-looking-for-job.md](./answers-why-looking-for-job.md) | Ответ: почему ищете работу (аккаунт в онлайн-школе) |
...
| [cover-letter-retail-service-labeling.md](./cover-letter-retail-service-labeling.md) | Ритейл Сервис · оператор разметки (CV/кассы) |
...
| [cover-letter-jol-ai-vibecoding-intern.md](./cover-letter-jol-ai-vibecoding-intern.md) | Jol AI · стажёр вайбкодинг (неоплач.) |
| [cover-letter-jol-ai-prompt-intern.md](./cover-letter-jol-ai-prompt-intern.md) | JOL AI · стажёр AI / Prompt Engineer → штат |
...
| [cover-letter-avigroup-junior-marketer.md](./cover-letter-avigroup-junior-marketer.md) | Avigroup · marketer |
| [cover-letter-zaytsev-ai-copywriter.md](./cover-letter-zaytsev-ai-copywriter.md) | Zaytsev · AI copywriter |
| [cover-letter-qooqa-am-response.md](./cover-letter-qooqa-am-response.md) | Qooqa · AM response |
| [cover-letter-m1nt-qa.md](./cover-letter-m1nt-qa.md) | M1NT · QA |
| [cover-letter-fl-kids-ai-product.md](./cover-letter-fl-kids-ai-product.md) | FL · kids AI product |
| [cover-letter-fl-telegram-mvp.md](./cover-letter-fl-telegram-mvp.md) | FL · Telegram MVP |
| [cover-letter-fl-ai-education.md](./cover-letter-fl-ai-education.md) | FL · AI education |

---

## Резюме и доп. материалы

| Файл | Описание |
|------|----------|
| [freelance-ru-resume.md](./freelance-ru-resume.md) | Текст для FL.ru / freelance |
...
- **Резюме SA (PDF):** https://portfolio-resume-alya-akbarova.vercel.app/resume-sa.pdf

**Контакты:** pilotalya@a-akbarova.ru · Telegram: @Albinaa_Akbarova

---

## Как адаптировать письмо за 5 минут

1. Открой **cover-letter-ai-native-engineer.md** (или role-specific файл).
2. Замени `[Компания / продукт / задача]` — 1–2 предложения из вакансии.
3. Выбери 2–3 кейса из блока «Арсенал» — не перечисляй всё.
4. Для QA/SA вакансий — добавь background-блок (Алиса, Browser, B2B audit) из templates.
5. Проверь: кейсы названы **проектами**, не «тестовым заданием».
